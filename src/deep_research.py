...
async def get_clarifying_questions(query: str):
    ...
    return (
        ...
        "",
        q_texts,
        "Clarifying questions generated. Answer them below, then click **Start Research**.",
    )


async def run_with_answers(query, answer1, answer2, answer3, state_questions):
    """Phase 2: run research using the user's answers."""
...
async def run_skip(query):
    """Skip clarification and run research on the original query only."""
